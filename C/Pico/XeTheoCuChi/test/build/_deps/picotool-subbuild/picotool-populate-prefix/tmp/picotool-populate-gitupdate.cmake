...
function(do_fetch)
  ...
  execute_process(
    COMMAND "C:/Program Files/Git/bin/git.exe" --git-dir=.git fetch --tags --force "origin"
...
function(get_hash_for_ref ref out_var err_var)
  execute_process(
    COMMAND "C:/Program Files/Git/bin/git.exe" --git-dir=.git rev-parse "${ref}^0"
    WORKING_DIRECTORY "D:/Learn/C/C/Arduino/XeTheoCuChi/test/build/_deps/picotool-src"
...
execute_process(
  COMMAND "C:/Program Files/Git/bin/git.exe" --git-dir=.git show-ref "develop"
  WORKING_DIRECTORY "D:/Learn/C/C/Arduino/XeTheoCuChi/test/build/_deps/picotool-src"
...
if(git_update_strategy MATCHES "^REBASE(_CHECKOUT)?$")
  ...
  execute_process(
    COMMAND "C:/Program Files/Git/bin/git.exe" --git-dir=.git symbolic-ref -q HEAD
    WORKING_DIRECTORY "D:/Learn/C/C/Arduino/XeTheoCuChi/test/build/_deps/picotool-src"
  ...
  if(current_branch STREQUAL "")
    ...
    execute_process(
      COMMAND "C:/Program Files/Git/bin/git.exe" --git-dir=.git for-each-ref "--format=%(upstream:short)" "${current_branch}"
      WORKING_DIRECTORY "D:/Learn/C/C/Arduino/XeTheoCuChi/test/build/_deps/picotool-src"
...
execute_process(
  COMMAND "C:/Program Files/Git/bin/git.exe" --git-dir=.git status --porcelain
  WORKING_DIRECTORY "D:/Learn/C/C/Arduino/XeTheoCuChi/test/build/_deps/picotool-src"
  RESULT_VARIABLE error_code
...
if(need_stash)
  execute_process(
    COMMAND "C:/Program Files/Git/bin/git.exe" --git-dir=.git stash save --quiet;--include-untracked
    WORKING_DIRECTORY "D:/Learn/C/C/Arduino/XeTheoCuChi/test/build/_deps/picotool-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  execute_process(
    COMMAND "C:/Program Files/Git/bin/git.exe" --git-dir=.git checkout "${checkout_name}"
    WORKING_DIRECTORY "D:/Learn/C/C/Arduino/XeTheoCuChi/test/build/_deps/picotool-src"
    COMMAND_ERROR_IS_FATAL ANY
    ${maybe_show_command}
  )
  ...
  execute_process(
    COMMAND "C:/Program Files/Git/bin/git.exe" --git-dir=.git rebase "${checkout_name}"
    WORKING_DIRECTORY "D:/Learn/C/C/Arduino/XeTheoCuChi/test/build/_deps/picotool-src"
    RESULT_VARIABLE error_code
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "C:/Program Files/Git/bin/git.exe" --git-dir=.git rebase --abort
      WORKING_DIRECTORY "D:/Learn/C/C/Arduino/XeTheoCuChi/test/build/_deps/picotool-src"
      ${maybe_show_command}
    )
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      if(need_stash)
        execute_process(
          COMMAND "C:/Program Files/Git/bin/git.exe" --git-dir=.git stash pop --index --quiet
          WORKING_DIRECTORY "D:/Learn/C/C/Arduino/XeTheoCuChi/test/build/_deps/picotool-src"
          ${maybe_show_command}
          )
      endif()
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/Learn/C/C/Arduino/XeTheoCuChi/test/build/_deps/picotool-src'."
    ...
    execute_process(
      COMMAND "C:/Program Files/Git/bin/git.exe" --git-dir=.git tag -a
...
if(need_stash)
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "C:/Program Files/Git/bin/git.exe" --git-dir=.git reset --hard --quiet
      WORKING_DIRECTORY "D:/Learn/C/C/Arduino/XeTheoCuChi/test/build/_deps/picotool-src"
      ${maybe_show_command}
    )
    execute_process(
      COMMAND "C:/Program Files/Git/bin/git.exe" --git-dir=.git stash pop --quiet
      WORKING_DIRECTORY "D:/Learn/C/C/Arduino/XeTheoCuChi/test/build/_deps/picotool-src"
      RESULT_VARIABLE error_code
      ${maybe_show_command}
    )
    if(error_code)
      ...
      execute_process(
        COMMAND "C:/Program Files/Git/bin/git.exe" --git-dir=.git reset --hard --quiet ${head_sha}
        WORKING_DIRECTORY "D:/Learn/C/C/Arduino/XeTheoCuChi/test/build/_deps/picotool-src"
        ${maybe_show_command}
      )
      execute_process(
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/Learn/C/C/Arduino/XeTheoCuChi/test/build/_deps/picotool-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
