...
void turnRight1()
{
    setMotor(HIGH, LOW, LOW, LOW, HIGH, LOW, LOW, LOW, defaultSpeed, 0, defaultSpeed, 0);
}

void turnRight2()
{
    setMotor(HIGH, LOW, LOW, HIGH, HIGH, LOW, LOW, HIGH, defaultSpeed, defaultSpeed, defaultSpeed, defaultSpeed);
}
